...
it('returns failure and shows error when user is not found', function () {
    $this->artisan('access:debug 9999')
        ->expectsOutputToContain('User not found.')
        ->assertFailed();
});

it('displays global roles and permissions when no scope is provided', function () {
...
it('displays scoped roles and permissions when scope option is provided', function () {
